                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="Enter your E-Mail"></asp:TextBox>
                                </div>
                                ...
                                <div class="form-group">
                                    <a href="CompanySignup.aspx"><input class="btn btn-info btn-block btn-lg" id="Button2" type="button" value="Dont have account yet? Sign Up!"/>
